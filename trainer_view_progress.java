...
public class trainer_view_progress {
...
//------------------------------------------------------------------------------------------------------------------
        ...
        String[][] current_metrics= DB.getProgressRecords(global.selected_member);
        if (current_metrics.length != 0){
            mem_bw = current_metrics[0][1]+" kgs";
            mem_bfp = current_metrics[0][2]+ "%";
        }

        JLabel bwtf = new JLabel(mem_bw);
        bwtf.setForeground(white);
        bwtf.setBounds(140,25,200,18);
        p1.add(bwtf);
        ...
        JLabel bfptf = new JLabel(mem_bfp);
        bfptf.setForeground(white);
        bfptf.setBounds(140,55,200,18);
        p1.add(bfptf);
        ...
        ActionListener CBchecker = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (year != null && month != null && day != null && year2 != null && month2 != null && day2 != null) {
                    Float[] progressData1 = DB.readProgress(global.selected_member, date1);
                    Float[] progressData2 = DB.readProgress(global.selected_member, date2);
...
//------------------------------------------------------------------------------------------------------------------
        ...
        String[][] data= DB.getProgressRecords(global.selected_member);
...
//------------------------------------------------------------------------------------------------------------------
        ...
        back.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                new trainer_view_personal_clients();
