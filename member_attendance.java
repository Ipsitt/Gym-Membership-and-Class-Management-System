...
import javax.swing.table.JTableHeader;
  ...
  public class member_attendance{
      ...
      public member_attendance() {
          ...
          JFrame Member_attendace_dates = new JFrame("Gym Membership And Class Management System");
          Member_attendace_dates.setResizable(false);
          Member_attendace_dates.setSize(500, 700);
          Member_attendace_dates.getContentPane().setBackground(Color.decode("#121212"));
          Member_attendace_dates.setLayout(null);
      ...
      //------------------------------------------------------------------------------------------------------------------
          ...
          back.addActionListener(new ActionListener(){
              public void actionPerformed(ActionEvent e){
                  ...
                  Member_attendace_dates.dispose();
                  new member_dashboard();
              }
          });
  //------------------------------------------------------------------------------------------------------------------
          //Add Panels-----
        //   Member_attendace_dates.add(p1);
          Member_attendace_dates.add(p2);
          Member_attendace_dates.add(back);
          Member_attendace_dates.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
          Member_attendace_dates.setVisible(true);
      }
  }
